...
(function( $ ) {
    ...
    $.fn.drawr = function( action, param ) {
        ...
        plugin.create_button = function(toolbox,type,data,css){
    	    ...
    	    el.css({ "outline" : "none", "text-align":"center","padding": "0px 0px 0px 0px","width" : "100%", "background" : "#eeeeee", "color" : "#000000","border":"0px","min-height":"30px","user-select": "none", "text-align": "center", "border-radius" : "0px" });
...
// jQuery.fn.drawr.register({
// 	icon: "mdi mdi-arrow-expand-horizontal mdi-24px",
// 	name: "arrownile",
// 	size: 3,
// 	alpha: 1,
// 	order: 2,
